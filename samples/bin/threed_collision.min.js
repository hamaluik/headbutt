...
"]"}try{d=b.toString}catch(g){return"???"}if(null!=d&&d!=Object.toString&&"function"==typeof d&&(c=b.toString(),"[object Object]"!=c))return c;c=null;d="{\n";a+="\t";e=null!=b.hasOwnProperty;for(c in b)e&&!b.hasOwnProperty(c)||"prototype"==c||"__class__"==c||"__super__"==c||"__interfaces__"==c||"__properties__"==c||(2!=d.length&&(d+=", \n"),d+=a+c+" : "+k.__string_rec(b[c],a));a=a.substring(1);return d+("\n"+a+"}");case "string":return b;default:return String(b)}};k.__interfLoop=function(b,a){if(null==
b)return!1;if(b==a)return!0;var c=b.__interfaces__;if(null!=c)for(var d=0,e=c.length;d<e;){var f=d++,f=c[f];if(f==a||k.__interfLoop(f,a))return!0}return k.__interfLoop(b.__super__,a)};k.__instanceof=function(b,a){if(null==a)return!1;switch(a){case Array:return b instanceof Array?null==b.__enum__:!1;case H:return"boolean"==typeof b;case K:return!0;case I:return"number"==typeof b;case L:return"number"==typeof b?(b|0)===b:!1;case String:return"string"==typeof b;default:if(null!=b)if("function"==typeof a){if(b instanceof
a||k.__interfLoop(k.getClass(b),a))return!0}else{if("object"==typeof a&&k.__isNativeObj(a)&&b instanceof a)return!0}else return!1;return a==M&&null!=b.__name__||a==N&&null!=b.__ename__?!0:b.__enum__==a}};k.__nativeClassName=function(b){b=k.__toStr.call(b).slice(8,-1);return"Object"==b||"Function"==b||"Math"==b||"JSON"==b?null:b};k.__isNativeObj=function(b){return null!=k.__nativeClassName(b)};k.__resolveNativeClass=function(b){return A[b]};var l=function(b){if(b instanceof Array&&null==b.__enum__)this.a=
b,this.byteLength=b.length;else{this.a=[];for(var a=0;a<b;){var c=a++;this.a[c]=0}this.byteLength=b}};l.__name__=!0;l.sliceImpl=function(b,a){var c=new J(this,b,null==a?null:a-b),d=new G(c.byteLength);(new J(d)).set(c);return d};l.prototype={slice:function(b,a){return new l(this.a.slice(b,a))},__class__:l};var r=function(){};r.__name__=!0;r._new=function(b,a,c){var d;if("number"==typeof b){d=[];for(a=0;a<b;){var e=a++;d[e]=0}d.byteLength=d.length<<2;d.byteOffset=0;b=[];a=0;for(e=d.length<<2;a<e;)a++,
b.push(0);d.buffer=new l(b)}else if(k.__instanceof(b,l)){null==a&&(a=0);null==c&&(c=b.byteLength-a>>2);d=[];for(e=0;e<c;){e++;var f=b.a[a++]|b.a[a++]<<8|b.a[a++]<<16|b.a[a++]<<24;d.push(v.i32ToFloat(f))}d.byteLength=d.length<<2;d.byteOffset=a;d.buffer=b}else if(b instanceof Array&&null==b.__enum__){d=b.slice();b=[];for(a=0;a<d.length;)e=d[a],++a,e=v.floatToI32(e),b.push(e&255),b.push(e>>8&255),b.push(e>>16&255),b.push(e>>>24);d.byteLength=d.length<<2;d.byteOffset=0;d.buffer=new l(b)}else throw new q("TODO "+
E.string(b));d.subarray=r._subarray;d.set=r._set;return d};r._set=function(b,a){if(k.__instanceof(b.buffer,l)){if(b.byteLength+a>this.byteLength)throw new q("set() outside of range");for(var c=0,d=b.byteLength;c<d;){var e=c++;this[e+a]=b[e]}}else if(b instanceof Array&&null==b.__enum__){if(b.length+a>this.byteLength)throw new q("set() outside of range");c=0;for(d=b.length;c<d;)e=c++,this[e+a]=b[e]}else throw new q("TODO");};r._subarray=function(b,a){var c=r._new(this.slice(b,a));c.byteOffset=4*b;
return c};var t=function(){};t.__name__=!0;t._new=function(b,a,c){if("number"==typeof b){c=[];for(a=0;a<b;){var d=a++;c[d]=0}c.byteLength=c.length;c.byteOffset=0;c.buffer=new l(c)}else if(k.__instanceof(b,l))null==a&&(a=0),null==c&&(c=b.byteLength-a),c=0==a?b.a:b.a.slice(a,a+c),c.byteLength=c.length,c.byteOffset=a,c.buffer=b;else if(b instanceof Array&&null==b.__enum__)c=b.slice(),c.byteLength=c.length,c.byteOffset=0,c.buffer=new l(c);else throw new q("TODO "+E.string(b));c.subarray=t._subarray;c.set=
t._set;return c};t._set=function(b,a){if(k.__instanceof(b.buffer,l)){if(b.byteLength+a>this.byteLength)throw new q("set() outside of range");for(var c=0,d=b.byteLength;c<d;){var e=c++;this[e+a]=b[e]}}else if(b instanceof Array&&null==b.__enum__){if(b.length+a>this.byteLength)throw new q("set() outside of range");c=0;for(d=b.length;c<d;)e=c++,this[e+a]=b[e]}else throw new q("TODO");};t._subarray=function(b,a){var c=t._new(this.slice(b,a));c.byteOffset=b;return c};String.prototype.__class__=String;
String.__name__=!0;Array.__name__=!0;var L={__name__:["Int"]},K={__name__:["Dynamic"]},I=Number;I.__name__=["Float"];var H=Boolean;H.__ename__=["Bool"];var M={__name__:["Class"]},N={},G=A.ArrayBuffer||l;null==G.prototype.slice&&(G.prototype.slice=l.sliceImpl);var h=A.Float32Array||r._new,J=A.Uint8Array||t._new;p.EPSILON=1E-7;k.__toStr={}.toString;r.BYTES_PER_ELEMENT=4;t.BYTES_PER_ELEMENT=1;F.main()})("undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:
this);
